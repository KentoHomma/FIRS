...
@WebServlet(name="deleteAction", urlPatterns={"/deleteAction"})
public class DeleteConfirm extends BaseServlet {
	//Mypage.jsp から UserDeleteConfirm.jsp への画面遷移時に使用するサーブレット
